...
```{r add-aside, child=if (knitr::is_html_output()) here::here("vignette/rmdchunks/aside.Rmd")}
```

```{r add-disclaimer, child=if (knitr::is_html_output()) here::here("vignette/rmdchunks/disclaimer.Rmd")}
```

```{r add-main-header, child=if (knitr::is_html_output()) here::here("vignette/rmdchunks/resume-main-header.Rmd")}
```
